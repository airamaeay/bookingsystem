<?php
    ...
    checkDefinition($user['definition'],'services','redirect');
    $error_message="";
    if(isset($_POST['new-service'])){
        ...
        $time_from = sanitize($con,$_POST['time_from']);
        $time_to = sanitize($con,$_POST['time_to']);
        $days = sanitize($con,$_POST['days']);
        $availability = $time_from."-".$time_to."--".$days; 
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-1">Choose time of availability</div>
                                        <div class="col-md-6">
                                            <input name="time_from" class="timepicker form-control mb-3">
                                        </div>
                                        <div class="col-md-6">
                                            <input name="time_to" class="timepicker form-control mb-3">
                                        </div>
                                    </div>
                                    <script>
                                        $('.timepicker').timepicker({
                                            ...
                                            //     $(this).attr("value",timepicker.selectedTime)
                                            // }
                                        });
                                    </script>
                                    <div class="row">
                                        <div class="col-md-12 mb-1">Choose day of availability</div>
                                        <div class="col-md-12">
                                            <div class="days">
                                                <span id="week" class="chooseWeek"></span>
                                            </div>
                                        </div>
                                    </div>
